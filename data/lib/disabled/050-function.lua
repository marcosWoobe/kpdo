...
doPlayerAddSkillTry(params.cid,5,getPlayerRequiredSkillTries(params.cid, 5, getPlayerSkill(params.cid,5)+1)) 
doPlayerAddSkillTry(params.enemy,4,getPlayerRequiredSkillTries(params.enemy, 4, getPlayerSkill(params.enemy,4)+1))
...
doPlayerAddSkillTry(params.cid,4,getPlayerRequiredSkillTries(params.cid, 4, getPlayerSkill(params.cid,4)+1)) 
doPlayerAddSkillTry(params.enemy,5,getPlayerRequiredSkillTries(params.enemy, 5, getPlayerSkill(params.enemy,5)+1))
...
addEvent(contagem,100, {cid = player,enemy = enemy,rounds = rounds})
