...
setPlayerStorageValue(cid, 4982, 748)
setPlayerStorageValue(cid, 4983, 1080)
setPlayerStorageValue(cid, 4984, 7)
setPlayerStorageValue(cid, 19987,1)
local rand = ginasio["Giovanni"]["poke"]
local randomico = math.random(1,rand.poke)
local monster = ginasio["Giovanni"][randomico]
...
setPlayerStorageValue(testar, 4982, 748)
setPlayerStorageValue(testar, 4983, 1080)
...
npcHandler:setMessage(MESSAGE_GREET, "Hello |PLAYERNAME|, I just a pokemon trainer and I Leader Gym Viridian,like to fight, go battle a me?")
