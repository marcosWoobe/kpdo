...
setPlayerStorageValue(cid, 4982, 699)
setPlayerStorageValue(cid, 4983, 832)
setPlayerStorageValue(cid, 4984, 7)
setPlayerStorageValue(cid, 19987,1)

local rand = ginasio["Brock"]["poke"]
local randomico = math.random(1,rand.poke)
local monster = ginasio["Brock"][randomico]
...
setPlayerStorageValue(testar, 4982, 699)
setPlayerStorageValue(testar, 4983, 832)
...
npcHandler:setMessage(MESSAGE_GREET, "Hello |PLAYERNAME|, I just a pokemon trainer and I Leader Gym Pewter,like to fight, go battle a me?")
