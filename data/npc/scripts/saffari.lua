local saffarienter = {x=1147, y=1411, z=7}
...
local talkUser = NPCHANDLER_CONVbehavior == CONVERSATION_DEFAULT and 0 or cid
		 ...
		 local xt = string.lower(msg)
		        if msgcontains(xt, 'saffari') then
 	                 	selfSay('You want to enter the safari for 5000 dollars?')
...
npcHandler:setMessage(MESSAGE_GREET, "Hello |PLAYERNAME|,Hello may I help you,  Go Saffari or now?")
