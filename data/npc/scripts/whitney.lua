...
if getPlayerStorageValue(cid, 9335) == 1 then
...
setPlayerStorageValue(cid, 4982, 1092)
setPlayerStorageValue(cid, 4983, 233)
setPlayerStorageValue(cid, 4984, 6)
setPlayerStorageValue(cid, 19987,1)

local rand = ginasio["Whitney"]["poke"]
local randomico = math.random(1,rand.poke)
local monster = ginasio["Whitney"][randomico]
...
setPlayerStorageValue(testar, 4982, 1092)
setPlayerStorageValue(testar, 4983, 233)
