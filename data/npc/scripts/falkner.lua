...
if getPlayerStorageValue(cid, 9337) == 1 then
...
setPlayerStorageValue(cid, 4982, 1284)
setPlayerStorageValue(cid, 4983, 302)
setPlayerStorageValue(cid, 4984, 7)
setPlayerStorageValue(cid, 19987,1)

local rand = ginasio["Falkner"]["poke"]
local randomico = math.random(1,rand.poke)
local monster = ginasio["Falkner"][randomico]
...
setPlayerStorageValue(testar, 4982, 1284)
setPlayerStorageValue(testar, 4983, 302)
