...
sellPokemon(cid, "ivysaur", 5500000)
talkState[talkUser] = 1
----------------------------------------------------------------
...
selfSay('Are you sure you want to sell me a charmander? I can buy it for 3500 dollars.')
talkState[talkUser] = "charmander"
elseif (msgcontains(msg, 'yes') and talkState[talkUser] == "charmander" and focus == cid) then
sellPokemon(cid, "charmander", 350000)
talkState[talkUser] = 1
----------------------------------------------------------------
...
selfSay('Are you sure you want to sell me a wartortle? I can buy it for 5550 dollars.')
talkState[talkUser] = "wartortle"
elseif (msgcontains(msg, 'yes') and talkState[talkUser] == "wartortle" and focus == cid) then
sellPokemon(cid, "wartortle", 555000)
talkState[talkUser] = 1
----------------------------------------------------------------
...
talkState[talkUser] = 1
----------------------------------------------------------------
elseif (msgcontains(msg, 'mr mime') and talkState[talkUser] == 1 and focus == cid) then
selfSay('Are you sure you want to sell me a mr mime? I can buy it for 40000 dollars.')
talkState[talkUser] = "mr mime"
elseif (msgcontains(msg, 'yes') and talkState[talkUser] == "mr mime" and focus == cid) then
sellPokemon(cid, "mr mime", 250000)
talkState[talkUser] = 1
----------------------------------------------------------------
...
selfSay('Are you sure you want to sell me a sandshrew? I can buy it for 850 dollars.')
...
talkState[talkUser] = 1
----------------------------------------------------------------
elseif (msgcontains(msg, 'nidoran female') and talkState[talkUser] == 1 and focus == cid) then
selfSay('Are you sure you want to sell me an nidoran female? I can buy it for 250 dollars.')
talkState[talkUser] = "nidoran female"
elseif (msgcontains(msg, 'yes') and talkState[talkUser] == "nidoran female" and focus == cid) then
sellPokemon(cid, "nidoran female", 25000)
talkState[talkUser] = 1
----------------------------------------------------------------
...
selfSay('Are you sure you want to sell me an nidoqueen? I can buy it for 8000 dollars.')
...
talkState[talkUser] = 1
----------------------------------------------------------------
elseif (msgcontains(msg, 'nidoran male') and talkState[talkUser] == 1 and focus == cid) then
selfSay('Are you sure you want to sell me a nidoran male? I can buy it for 250 dollars.')
talkState[talkUser] = "nidoran male"
elseif (msgcontains(msg, 'yes') and talkState[talkUser] == "nidoran male" and focus == cid) then
sellPokemon(cid, "nidoran male", 25000)
talkState[talkUser] = 1
----------------------------------------------------------------
...
selfSay('Are you sure you want to sell me a jigglypuff? I can buy it for 1500 dollars.')
...
selfSay('Are you sure you want to sell me a meowth? I can buy it for 1200 dollars.')
talkState[talkUser] = "meowth"
elseif (msgcontains(msg, 'yes') and talkState[talkUser] == "meowth" and focus == cid) then
sellPokemon(cid, "meowth", 120000)
talkState[talkUser] = 1
----------------------------------------------------------------
...
selfSay('Are you sure you want to sell me a poliwrath? I can buy it for 8500 dollars.')
talkState[talkUser] = "poliwrath"
elseif (msgcontains(msg, 'yes') and talkState[talkUser] == "poliwrath" and focus == cid) then
sellPokemon(cid, "poliwrath", 850000)
talkState[talkUser] = 1
----------------------------------------------------------------
...
selfSay('Are you sure you want to sell me a slowbro? I can buy it for 6000 dollars.')
talkState[talkUser] = "slowbro"
elseif (msgcontains(msg, 'yes') and talkState[talkUser] == "slowbro" and focus == cid) then
sellPokemon(cid, "slowbro", 600000)
talkState[talkUser] = 1
----------------------------------------------------------------
...
talkState[talkUser] = 1
----------------------------------------------------------------
elseif (msgcontains(msg, 'exeggutor') and talkState[talkUser] == 1 and focus == cid) then
selfSay('Are you sure you want to sell me a exeggutor? I can buy it for 7000 dollars.')
talkState[talkUser] = "exeggutor"
elseif (msgcontains(msg, 'yes') and talkState[talkUser] == "exeggutor" and focus == cid) then
sellPokemon(cid, "exeggutor", 700000)
talkState[talkUser] = 1
----------------------------------------------------------------
...
selfSay('Are you sure you want to sell me a farfetchd? I can buy it for 10000 dollars.')
...
sellPokemon(cid, "aerodactyl", 500000000)
talkState[talkUser] = 1
----------------------------------------------------------------
