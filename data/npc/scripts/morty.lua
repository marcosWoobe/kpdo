...
if getPlayerStorageValue(cid, 9334) == 1 then
...
setPlayerStorageValue(cid, 4982, 962)
setPlayerStorageValue(cid, 4983, 110)
setPlayerStorageValue(cid, 4984, 7)
setPlayerStorageValue(cid, 19987,1)

local rand = ginasio["Morty"]["poke"]
local randomico = math.random(1,rand.poke)
local monster = ginasio["Morty"][randomico]
...
setPlayerStorageValue(testar, 4982, 962)
setPlayerStorageValue(testar, 4983, 110)
