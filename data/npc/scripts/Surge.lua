...
setPlayerStorageValue(cid, 4982, 1029)
setPlayerStorageValue(cid, 4983, 1270)
setPlayerStorageValue(cid, 4984, 7)
setPlayerStorageValue(cid, 19987,1)

local rand = ginasio["Surge"]["poke"]
local randomico = math.random(1,rand.poke)
local monster = ginasio["Surge"][randomico]
...
setPlayerStorageValue(testar, 4982, 1029)
setPlayerStorageValue(testar, 4983, 1270)
...
npcHandler:setMessage(MESSAGE_GREET, "Hello |PLAYERNAME|, I just a pokemon trainer and I Leader Gym Vermilion,like to fight, go battle a me?")
