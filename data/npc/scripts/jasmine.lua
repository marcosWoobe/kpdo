...
if getPlayerStorageValue(cid, 9332) == 1 then
...
setPlayerStorageValue(cid, 4982, 726)
setPlayerStorageValue(cid, 4983, 215)
setPlayerStorageValue(cid, 4984, 7)
setPlayerStorageValue(cid, 19987,1)

local rand = ginasio["Jasmine"]["poke"]
local randomico = math.random(1,rand.poke)
local monster = ginasio["Jasmine"][randomico]
...
setPlayerStorageValue(testar, 4982, 726)
setPlayerStorageValue(testar, 4983, 215)
