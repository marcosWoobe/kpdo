...
setPlayerStorageValue(cid, 4982, 1094)
setPlayerStorageValue(cid, 4983, 1041)
setPlayerStorageValue(cid, 4984, 7)
setPlayerStorageValue(cid, 19987,1)

local rand = ginasio["Sabrina"]["poke"]
local randomico = math.random(1,rand.poke)
local monster = ginasio["Sabrina"][randomico]
...
setPlayerStorageValue(testar, 4982, 1094)
setPlayerStorageValue(testar, 4983, 1041)
...
npcHandler:setMessage(MESSAGE_GREET, "Hello |PLAYERNAME|, I just a pokemon trainer and I Leader Gym Saffron,like to fight, go battle a me?")
