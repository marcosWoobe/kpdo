...
setPlayerStorageValue(cid, 4982, 1402)
setPlayerStorageValue(cid, 4983, 40)
setPlayerStorageValue(cid, 4984, 6)
setPlayerStorageValue(cid, 19987,1)

local rand = ginasio["Clair"]["poke"]
local randomico = math.random(1,rand.poke)
local monster = ginasio["Clair"][randomico]
...
setPlayerStorageValue(testar, 4982, 1402)
setPlayerStorageValue(testar, 4983, 40)
