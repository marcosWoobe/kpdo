...
setPlayerStorageValue(cid, 4982, 854)
setPlayerStorageValue(cid, 4983, 1113)
setPlayerStorageValue(cid, 4984, 6)
setPlayerStorageValue(cid, 19987,1)

local rand = ginasio["Erika"]["poke"]
local randomico = math.random(1,rand.poke)
local monster = ginasio["Erika"][randomico]
...
setPlayerStorageValue(testar, 4982, 854)
setPlayerStorageValue(testar, 4983, 1113)
setPlayerStorageValue(testar, 4984, 6)
...
npcHandler:setMessage(MESSAGE_GREET, "Hello |PLAYERNAME|, I just a pokemon trainer and I Leader Gym Celadon,like to fight, go battle a me?")
