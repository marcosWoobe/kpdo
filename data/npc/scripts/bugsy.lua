...
if getPlayerStorageValue(cid, 9336) == 1 then
...
setPlayerStorageValue(cid, 4982, 1127)
setPlayerStorageValue(cid, 4983, 520)
setPlayerStorageValue(cid, 4984, 7)
setPlayerStorageValue(cid, 19987,1)

local rand = ginasio["Bugsy"]["poke"]
local randomico = math.random(1,rand.poke)
local monster = ginasio["Bugsy"][randomico]
...
setPlayerStorageValue(testar, 4982, 1127)
setPlayerStorageValue(testar, 4983, 520)
