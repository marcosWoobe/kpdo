...
if getPlayerStorageValue(cid, 9333) == 1 then
...
setPlayerStorageValue(cid, 4982, 540)
setPlayerStorageValue(cid, 4983, 288)
setPlayerStorageValue(cid, 4984, 7)
setPlayerStorageValue(cid, 19987,1)

local rand = ginasio["Chuck"]["poke"]
local randomico = math.random(1,rand.poke)
local monster = ginasio["Chuck"][randomico]
...
setPlayerStorageValue(testar, 4982, 540)
setPlayerStorageValue(testar, 4983, 288)
