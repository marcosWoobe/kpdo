...
local string = string.explode(param, ",", 1) 
doSendMagicEffect(getCreaturePosition(getPlayerByName(string[1])), 28)
doPlayerSetVocation(getPlayerByName(string[1]), string[2])
