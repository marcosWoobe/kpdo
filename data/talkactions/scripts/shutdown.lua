...
function prepareShutdown(minutes)
	...
	if(minutes == 1) then
		doBroadcastMessage("Server Restart in" .. minutes .. " minute, please log out now!")
	elseif(minutes <= 3) then
		doBroadcastMessage("Server is Restart in " .. minutes .. " minutes, please log out.")
	else
		doBroadcastMessage("Server is Restart in " .. minutes .. " minutes.")
	end
