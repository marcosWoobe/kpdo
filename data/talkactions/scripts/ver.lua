...
local horas = verponto(getPlayerByName(param))
if horas >= 60*60 then
local novocalc = horas/3600
doPlayerSendTextMessage(cid,22,novocalc.." horas logadas" )
else
doPlayerSendTextMessage(cid,22,horas.." segundos logados" )
end
