...
if not pokemon then
  if getPlayerStorageValue(getCreatureSummons(cid)[1], 1236) <= 0 then
                   return true
end
	end
...
--pokemon.ex = 957652+mstring(words)
end
...
pokemon = tmspell
pokemon.minLv =  getPlayerStorageValue(getCreatureSummons(cid)[1], 1236)
else
if not pokemon then
return true
end
...
if getTileInfo(getCreaturePosition(getCreatureSummons(cid)[1])).protection or getTileInfo(getCreaturePosition(cid)).protection  then
	...
	doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE, "You don\'t have enough level ,need "..pokemon.minLv.." to  this move.")
	return 0
	end
...
local num1 = (pokemon.minLv*1.5)
local num2 = (pokemon.minLv*2)
...
num3 = (pokemon.bonus)*1.2
else
num3 = (pokemon.bonus)
end
local lvpokemon = boost+leveldoplayer
modeFight = getModeFight(cid)
if modeFight  == 1 then
num3 = num3 * 1.2
...
if getPlayerStorageValue(getCreatureSummons(cid)[1], 255) >= 1 then
if math.random(1,100) <= 40 then
doSendMagicEffect(getThingPos(getCreatureSummons(cid)[1]), 208)
	num3 = num3 * 1.8
end
...
doSendMagicEffect(getThingPos(getCreatureTarget(cid)), 230)
		doAreaCombatHealth(getCreatureSummons(cid)[1], element, getThingPos(getCreatureTarget(cid)), 0, -((num1)+(lvpokemon*(num3))), -((num2)+(lvpokemon*(num3))), 229)
		return 0
...
doAreaCombatHealth(getCreatureSummons(cid)[1], element, getThingPos(getCreatureTarget(cid)), 0, -((num1)+(lvpokemon*(num3))), -((num2)+(lvpokemon*(num3))), 185)
		return 0
...
if getPlayerStorageValue(cid, 6333) == getCreatureMaster(pid) or getPlayerStorageValue(cid,4333) >= 1 then
Confunso(pid)
end
end
...
elseif pokemon.spell == "Icy Wind" then
	...
	elseif pokemon.spell == "Psychic" then
		...
		doAreaCombatHealth(getCreatureSummons(cid)[1], element, getThingPos(getCreatureSummons(cid)[1]), psychic, -((num1)+(lvpokemon*(num3))), -((num2)+(lvpokemon*(num3))), 251)
	return 0
	elseif pokemon.spell == "Thunder" then


		
		doAreaCombatHealth(getCreatureSummons(cid)[1], element, getThingPos(getCreatureSummons(cid)[1]), Thunder, -((num1)+(lvpokemon*(num3))), -((num2)+(lvpokemon*(num3))), 48)
	return 0
...
doSendMagicEffect(getCreaturePosition(getCreatureSummons(cid)[1]), 246)	
		
		doAreaCombatHealth(getCreatureSummons(cid)[1], element, getThingPos(getCreatureSummons(cid)[1]), psychic, -((num1)+(lvpokemon*(num3))), -((num2)+(lvpokemon*(num3))), 186)
	return 0
...
elseif pokemon.spell == "Falling Rocks" then
		...
		doAreaCombatHealth(getCreatureSummons(cid)[1], element, pos, 0, -((num1)+(lvpokemon*(num3))), -((num2)+(lvpokemon*(num3))), 183)
		end
		end
		end
...
elseif pokemon.spell == "Metronome" then
		...
		frompos.y = pos.y - 6
		doSendDistanceShoot(frompos, pos, 11)
		doAreaCombatHealth(getCreatureSummons(cid)[1], ROCKDAMAGE, pos, 0, -((num1)+(lvpokemon*(num3))), -((num2)+(lvpokemon*(num3))), 44)
		end
		end
		end
...
local function eletri(params)
		...
		doAreaCombatHealth(getCreatureSummons(cid)[1], ELECTRICDAMAGE, pos, 0, -((num1)+(lvpokemon*(num3))), -((num2)+(lvpokemon*(num3))), 11)
		end
		end
		end
...
local function shadow(params)
		...
		doAreaCombatHealth(getCreatureSummons(cid)[1], GHOSTDAMAGE, pos, 0, -((num1)+(lvpokemon*(num3))), -((num2)+(lvpokemon*(num3))), 140)
		end
		end
		end
	...
	local function dragon(params)
		...
		doAreaCombatHealth(getCreatureSummons(cid)[1], DRAGONDAMAGE, pos, 0, -((num1)+(lvpokemon*(num3))), -((num2)+(lvpokemon*(num3))), 5)
		end
		end
		end
...
elseif pokemon.spell == "Electric Storm" then
		...
		frompos.y = pos.y - 6
		doSendDistanceShoot(frompos, pos, 40)
		doAreaCombatHealth(getCreatureSummons(cid)[1], element, pos, 0, -((num1)+(lvpokemon*(num3))), -((num2)+(lvpokemon*(num3))), 48)
		end
		end
		end
...
elseif pokemon.spell == "Sludge Rain" then
		...
		doAreaCombatHealth(params.cid, element, pos, pu, -((num1)+(lvpokemon*(num3))), -((num2)+(lvpokemon*(num3))), 254)
		end
...
doChangeSpeed(summons, bspd+100)
	...
	elseif getCreatureName(getCreatureSummons(cid)[1]) == "Voltorb" then
		...
		elseif getCreatureName(getCreatureSummons(cid)[1]) == "Shiny Electrode" then
		doSetCreatureOutfit(getCreatureSummons(cid)[1], shinyelectrode, 8300)

	elseif getCreatureName(getCreatureSummons(cid)[1]) == "Shiny Voltorb" then
		doSetCreatureOutfit(getCreatureSummons(cid)[1], shinyvoltorb, 8300)
...
doAreaCombatHealth(getCreatureSummons(cid)[1], element, getThingPos(getCreatureSummons(cid)[1]), quake, -((num1)+(lvpokemon*(num3))), -((num1)+(lvpokemon*(num3))), 252)
...
elseif pokemon.spell == "Calm Mind" then
		...
		doSendMagicEffect(getThingPos(getCreatureSummons(cid)[1]), 172)
...
elseif pokemon.spell == "Psycho Shift" then
		...
		pos.x = pos.x + math.random(1,4) 
		pos.y = pos.y + math.random(1,4) 
		...
		doAreaCombatHealth(getCreatureSummons(cid)[1], element, getThingPos(getCreatureTarget(cid)), 0, -((num1)+(lvpokemon*(num3))), -((num2)+(lvpokemon*(num3))), 238)
...
elseif pokemon.spell == "Raging Blast" then
		...
		doAreaCombatHealth(getCreatureSummons(cid)[1], element, getThingPos(getCreatureSummons(cid)[1]), rageblast1, -((num1)+(lvpokemon*(num3))), -((num2)+(lvpokemon*(num3))), 181)
	local function damage(params)
		if isCreature(params.cid) then
...
local destruct = getCreatureHealth(getCreatureSummons(cid)[1])
		doAreaCombatHealth(getCreatureSummons(cid)[1], element, getThingPos(getCreatureSummons(cid)[1]), destruct1, -destruct, -destruct, 181)
		addEvent(doAreaCombatHealth, 150, getCreatureSummons(cid)[1], element, getThingPos(getCreatureSummons(cid)[1]), destruct2,  -destruct, -destruct, 181)
		addEvent(doAreaCombatHealth, 350, getCreatureSummons(cid)[1], element, getThingPos(getCreatureSummons(cid)[1]), destruct3,  -destruct, -destruct, 181)
...
elseif pokemon.spell == "Dragon Rush" then
		...
		doAreaCombatHealth(getCreatureSummons(cid)[1], element, getThingPos(getCreatureSummons(cid)[1]), psy1, -((num1)+(lvpokemon*(num3))), -((num1)+(lvpokemon*(num3))), 253)
...
elseif pokemon.spell == "Dragon Breath" then
		...
		doAreaCombatHealth(getCreatureSummons(params.cid)[1], element, params.ar, arr1, -((num1)+(lvpokemon*(num3))), -((num2)+(lvpokemon*(num3))), 253)
...
local function psycon(params)
	if isCreature(params.cid) then
	doAreaCombatHealth(params.cid, element, getThingPos(params.cid), mew, -((num1)+(lvpokemon*(num3))), -((num2)+(lvpokemon*(num3))), 172)
	end
	end
