...
if getPlayerStorageValue(cid, 19988) >= 1  then
setPlayerStorageValue(cid, 19988,0)
doPlayerSendTextMessage(cid,22,"Auto KICK BY PING DISABLED")
else
setPlayerStorageValue(cid, 19988,1)
doPlayerSendTextMessage(cid,22,"Auto KICK BY PING ENABLED")
end
return true
