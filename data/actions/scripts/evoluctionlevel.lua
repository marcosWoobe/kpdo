...
pokenick = getItemAttribute(pokeball.uid, "nome")
...
local jatem = getGlobalStorageValue(1135)

setGlobalStorageValue(1135,jatem+1)
...
local jatem = getGlobalStorageValue(1134)

setGlobalStorageValue(1134,jatem+1)
local jatem = getGlobalStorageValue(1133)
...
local jatem = getGlobalStorageValue(1136)

setGlobalStorageValue(1136,jatem+1)
local jatem = getGlobalStorageValue(1133)
...
return doPlayerSendCancel(cid, "Sorry, you pokemon is level "..lvpokemon.." don't have the required level to evolve this pokemon need ("..levell..").")
end
...
doPlayerSendTextMessage(cid, 27, "Congratulations! Your "..pokenick.." evolved into a "..evo.."!")
