...
seconds1 = math.floor(((exhaustion.get(cid, 31000)) )) 
...
seconds2 = math.floor(((exhaustion.get(cid, 31001)) )) 
...
seconds3 = math.floor(((exhaustion.get(cid, 31002)) ))
...
seconds4 = math.floor(((exhaustion.get(cid, 31003)) )) 
...
seconds5 = math.floor(((exhaustion.get(cid, 31004)) )) 
...
seconds6 = math.floor(((exhaustion.get(cid, 31005)) ))
...
seconds7 = math.floor(((exhaustion.get(cid, 31006)) )) 
...
seconds8 = math.floor(((exhaustion.get(cid, 31007)) )) 
...
seconds9 = math.floor(((exhaustion.get(cid, 31008)) )) 
...
seconds10 = math.floor(((exhaustion.get(cid, 31009)) )) 
...
seconds11 = math.floor(((exhaustion.get(cid, 31010)) )) 
...
seconds12 = math.floor(((exhaustion.get(cid, 31011)) )) 
