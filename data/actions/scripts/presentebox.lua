...
local box1item =
{
[1] = {name = "Diamond",itemid = 2145,chance = 60,mx = 1,mn = 3},
...
[6] = {name = "Golden Candy",itemid = 9516,chance = 20,mx=1, mn = 3},
[7] = {name = "Tm Remover",itemid =9556,chance = 15,mx=1,mn=1},
...
if(doPlayerRemoveItem(cid, 11225, 1) == true) then  
