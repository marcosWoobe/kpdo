...
if getPlayerStorageValue(cid, 5333) >= 2 then
inimigo = getPlayerStorageValue(cid,6333)
alavanca2pos = {x=982, y=1043, z=2, stackpos=1}
alavanca1pos = {x=982, y=1040, z=2, stackpos=1}
alavanca1 = getThingfromPos(alavanca1pos)
alavanca2 = getThingfromPos(alavanca2pos)
doTransformItem(alavanca1.uid,1485)
doTransformItem(alavanca2.uid,1485)
...
if getPlayerStorageValue(cid, 5333) >= 3 then
...
if getPlayerStorageValue(cid, 5333) >= 4 then

inimigo = getPlayerStorageValue(cid,6333)
alavanca2pos = {x=988, y=1043, z=2, stackpos=1}
alavanca1pos = {x=988, y=1040, z=2, stackpos=1}
alavanca1 = getThingfromPos(alavanca1pos)
alavanca2 = getThingfromPos(alavanca2pos)
doTransformItem(alavanca1.uid,1485)
doTransformItem(alavanca2.uid,1485)
...
if #getCreatureSummons(cid) >= 1 then
doTeleportThing(getCreatureSummons(cid)[1], {x=975,y=1032
,z=0})
end
...
if getPlayerStorageValue(cid, 5333) >= 1 then
if getPlayerStorageValue(cid, 5333) == 1 then
if getPlayerStorageValue(cid, 2333) == 6 then
local alavanca2pos = {x=979, y=1043, z=2, stackpos=1}
local alavanca1pos = {x=979, y=1040, z=2, stackpos=1}
alavanca1 = getThingfromPos(alavanca1pos)
alavanca2 = getThingfromPos(alavanca2pos)
doTransformItem(alavanca1.uid,1485)
doTransformItem(alavanca2.uid,1485)
...
if getPlayerStorageValue(cid, 2333) == 5 then
...
if getPlayerStorageValue(cid, 2333) == 4 then
...
if getPlayerStorageValue(cid, 2333) == 3 then
