...
player1pos = {x = 983, y = 1040, z = 2, stackpos=253}
player1 = getThingfromPos(player1pos)

player2pos = {x = 983, y = 1043, z = 2, stackpos=253}
...
if item2.actionid == 9235 then




doTransformItem(item.uid,1484)
elseif item2.actionid == 9236 then
...
doTeleportThing(getCreatureSummons(player1.uid)[1], {x = 970, y = 1026, z = 3})
...
doTeleportThing(getCreatureSummons(player2.uid)[1], {x = 973, y = 1026, z = 3})
...
setPlayerStorageValue(player1.uid, 5333, 2)
setPlayerStorageValue(player2.uid, 5333, 2)
...
doTeleportThing(player1.uid, {x = 970, y = 1026, z = 3})
doTeleportThing(player2.uid, {x = 973, y = 1026, z = 3})
