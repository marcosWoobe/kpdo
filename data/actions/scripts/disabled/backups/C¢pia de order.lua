...
d40 = 
{
        ...
        [3] = {pokemon = 'Goldeen p'}, 
        [4] = {pokemon = 'Krabby p'}, 
        [5] = {pokemon = 'Tentacool p'}, 
        [6] = {pokemon = 'seel p'},
        [7] = {pokemon = 'shellder p'},
}
...
d80 = 
{
        ...
        [10] = {pokemon = 'staryu p'}, 
        [11] = {pokemon = 'seel p'},
        [12] = {pokemon = 'shellder p'},
        [13] = {pokemon = 'Poliwhirl p'},
        [14] = {pokemon = 'golduck p'},
...
d90 = 
{
        ...
        [12] = {pokemon = 'shellder p'},
        [13] = {pokemon = 'Poliwhirl p'},
        [14] = {pokemon = 'Cloyster p'},
        [15] = {pokemon = 'Dewgong p'},
        [16] = {pokemon = 'golduck p'},
...
d100 = 
{
        ...
        [12] = {pokemon = 'shellder p'},
        [13] = {pokemon = 'Poliwhirl p'},
        [14] = {pokemon = 'Poliwrath p'},
        [15] = {pokemon = 'Cloyster p'},
        [16] = {pokemon = 'Dewgong p'},
        [18] = {pokemon = 'Gyarados p'},
        [17] = {pokemon = 'golduck p'},
...
setPlayerStorageValue(getCreatureSummons(cid)[1], 109, item2.itemid)
doChangeSpeed(getCreatureSummons(cid)[1], -getCreatureSpeed(getCreatureSummons(cid)[1]))
	local function tocut(params)
	if isCreature(params.cid) then
	if isCreature(getCreatureSummons(params.cid)[1]) then
...
doPlayerAddSkillTry(params.cid, 3, 5)


local skill = getPlayerSkillLevel(cid, 3)
doTransformItem(getTileItemById(topos, getPlayerStorageValue(getCreatureSummons(params.cid)[1], 109)).uid, 7024)
...
doTransformItem(getTileItemById(topos, 7024).uid, getPlayerStorageValue(getCreatureSummons(params.cid)[1], 109))
			if isCreature(getCreatureSummons(params.ciddd)[1]) then
			setPlayerStorageValue(getCreatureSummons(params.ciddd)[1], 100, 0)
			end
		end
	addEvent(detrans, 5500, {ciddd = cid})
	doCreatureSay(getCreatureSummons(cid)[1], "HeadButt", TALKTYPE_MONSTER)
	local function nmr(params)
	if isCreature(params.cid) then
	if isCreature(getCreatureSummons(params.cid)[1]) then
		if getCreatureSpeed(getCreatureSummons(params.cid)[1]) == 0 then
...
exhaustion.set(cid, temk*travel, travel)
return true
end