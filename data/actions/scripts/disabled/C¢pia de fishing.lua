                ...
                doSendMagicEffect(toPos, CONST_ME_LOSEENERGY)
					...
					doSendMagicEffect(getThingPos(cid), 173)
                        ...
                        if skill == 21 then
                                local random = math.random(1, 100)
                                if random <= 45 then
                                        doSummonCreature(d12[math.random(0,11)].pokemon, playerpos)
					if #getCreatureSummons(cid) >= 1 then
					doSendMagicEffect(getThingPos(getCreatureSummons(cid)[1]), 173)
					else
					doSendMagicEffect(getThingPos(cid), 173)
                        ...
                        if skill == 20 then
                                local random = math.random(1, 100)
                                if random <= 45 then
                                        doSummonCreature(d11[math.random(0,10)].pokemon, playerpos)
					if #getCreatureSummons(cid) >= 1 then
					doSendMagicEffect(getThingPos(getCreatureSummons(cid)[1]), 173)
					else
					doSendMagicEffect(getThingPos(cid), 173)
					...
					doSendMagicEffect(getThingPos(cid), 173)
                        ...
                        if skill == 18 then
                                local random = math.random(1, 100)
                                if random <= 45 then
                                        doSummonCreature(d9[math.random(0,8)].pokemon, playerpos)
					if #getCreatureSummons(cid) >= 1 then
					doSendMagicEffect(getThingPos(getCreatureSummons(cid)[1]), 173)
					else
					doSendMagicEffect(getThingPos(cid), 173)
