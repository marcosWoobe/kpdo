...
player1pos = {x = 989, y = 1040, z = 2, stackpos=253}
player1 = getThingfromPos(player1pos)

player2pos = {x = 989, y = 1043, z = 2, stackpos=253}
...
if item2.actionid == 9239 then




doTransformItem(item.uid,1484)
elseif item2.actionid == 9240 then
...
doTeleportThing(getCreatureSummons(player1.uid)[1], {x = 986, y = 1025, z = 3})
...
doTeleportThing(getCreatureSummons(player2.uid)[1], {x = 986, y = 1027, z = 3})
...
setPlayerStorageValue(player1.uid, 5333, 4)
setPlayerStorageValue(player2.uid, 5333, 4)
...
doTeleportThing(player1.uid, {x = 986, y = 1025, z = 3})
doTeleportThing(player2.uid, {x = 986, y = 1027, z = 3})
