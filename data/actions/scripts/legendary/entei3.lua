...
local monster1 = {x=121,y=1116,z=9}
local monster2 = {x=120,y=1116,z=9}
local monster3 = {x=120,y=1108,z=9}
local monster4 = {x=121,y=1108,z=9}
local monster5 = {x=120,y=1110,z=9}
local monster6 = {x=95,y=1113,z=9}

actionstatus = getPlayerStorageValue(cid,90202)
if actionstatus == -1 then
if doCreatureSay(cid,"You have found the secret swich, beware!",TALKTYPE_ORANGE_1) then
setPlayerStorageValue(cid,90202,1)
else
