...
local monster1 = {x=1165,y=602,z=12}
local monster2 = {x=1166,y=602,z=12}
local monster3 = {x=1167,y=602,z=12}
local monster4 = {x=1168,y=602,z=12}
local monster5 = {x=1165,y=598,z=12}
local monster6 = {x=1167,y=598,z=12}

actionstatus = getPlayerStorageValue(cid,90211)
if actionstatus == -1 then
if doCreatureSay(cid,"You have found the secret swich, beware!",TALKTYPE_ORANGE_1) then
setPlayerStorageValue(cid,90211,1)
else
