...
local monstername2 = "fire22"
local monster1 = {x=411,y=1865,z=5}
local monster2 = {x=395,y=1859,z=5}
local monster3 = {x=409,y=1865,z=5}

actionstatus = getPlayerStorageValue(cid,90026)
if actionstatus == -1 then
if doCreatureSay(cid,"You have found the secret swich, beware!",TALKTYPE_ORANGE_1) then
setPlayerStorageValue(cid,90026,1)
else
